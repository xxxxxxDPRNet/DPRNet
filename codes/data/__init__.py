...
def create_dataset(dataset_opt):
    ...
    elif mode == 'LQGT_video':
        from data.LQGT_enhance_video_dataset import LQGT_video_dataset as D
    elif mode == 'Night_imaging':
        from data.Night_imaging_dataset import Night_imaging_dataset as D
    ...
    elif mode == 'LQGT_enhance_dataset_hdrheaven':
        from data.LQGT_enhance_dataset_hdrheaven import LQGT_enhance_dataset_hdrheaven as D
    else:
